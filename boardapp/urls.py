...
logoutfunc, detailfunc, goodfunc, BoardCreate, profilefunc, BoardDelete, BoardUpdate, followfunc, followpagefunc, ProfileCreate, updatefunc, update2func
urlpatterns = [
	...
	path('update2/<int:pk>', update2func, name='update2'),
